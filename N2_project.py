...
def Cadastro_Candidatos():
   while True:
      ...
      while True:
         ...
         if cargo == 'GOVERNADOR':
            lista_Partidos_Governador.append(cargo)
            ...
            lista_Cargos_Prefeito.append(cargo)
            ...
            lista_Cargos_Presidente.append(cargo)
